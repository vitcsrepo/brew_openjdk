cask 'java' do
  ...
  url "https://download.java.net/java/GA/jdk#{version.major}/#{version.before_comma}/fb4372174a714e6b8c52526dc134031e/#{version.major}/openjdk-#{version.before_comma}_osx-x64_bin.tar.gz"
  name 'OpenJDK'
